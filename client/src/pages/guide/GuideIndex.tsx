...
const GUIDE_MODULES: GuideModule[] = [
  {
    ...
    subtitle: "GHL-pipeline, NDA & avtal, FasciaVibes-access, portalkonto och licens",
    icon: Users,
    href: "/guide/del1",
    available: true,
    slides: 7,
  ...
  },
  {
    ...
    subtitle: "Registrera kurstillfälle, deltagarlista, markera showed, skicka meddelanden",
    icon: ClipboardList,
    href: "/guide/del3",
    available: false,
    slides: 0,
  ...
  },
  {
    ...
    subtitle: "Bokningsflöde, GHL pipeline, kursgenomförande, certifikat och verifiering",
    icon: GraduationCap,
    href: "/guide/del7",
    available: false,
    slides: 0,
